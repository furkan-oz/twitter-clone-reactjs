...
const LeftSideBar = () => {
    ...
    return (
        <div className="leftSideBar">
            ...
            <div className="tweetButton"><Buttons buttonText={"Tweet"} buttonType={"btn-primary sideBarTweetButton"} /></div>
                ...
                <div className="profile-item" >
                    ...
                    <div className="profile">
                            ...
                            <div className="profileInfo">
                                <div className="profileName">Furkan Öz</div>
                                <div className="profileNickName">@frkan_oz</div>
                            </div>
